...
\begin{itemize}
    ...
    \item \textbf{Dependientes:} Accuracy, F1-score macro, épocas hasta convergencia, parámetros entrenables
...
\begin{quote}
    \textit{La aplicación de data augmentation moderada (rotación $\pm$15°, flip horizontal, variación de brillo $\pm$20\%) incrementará el recall de las 5 familias de malware con menor representación ($<$100 muestras) en al menos 15 puntos porcentuales, sin degradar el accuracy global del modelo en más de 2\%.}
\end{quote}

\textbf{Variables:}
\begin{itemize}
    \item \textbf{Independiente:} Aplicación de data augmentation (con/sin)
    \item \textbf{Dependientes:} Recall de clases minoritarias, accuracy global
