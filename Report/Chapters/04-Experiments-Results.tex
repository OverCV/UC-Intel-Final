...
El objetivo central de este experimento es verificar empíricamente la hipótesis H3: \textit{``Incrementar la profundidad de una CNN custom mejorará el rendimiento del modelo, pero con rendimientos decrecientes y mayor costo computacional.''} 
...
\begin{figure}[h]
\centering
\includegraphics[width=0.45\textwidth]{Figures/H3/c1.jpg}
\includegraphics[width=0.45\textwidth]{Figures/H3/c2.jpg}
\caption{Comparación de curvaturas de entrenamiento para el Experimento 3: Accuracy (izquierda) y Loss (derecha).}
\label{fig:curves-exp3}
\end{figure}


\subsection{Configuración de Arquitecturas y Entrenamiento}
...
\hline
\textbf{Filosofía de Diseño} & Arquitectura moderadamente profunda con 2 bloques convolucionales. Enfoque en extracción jerárquica de características sin complejidad excesiva. & Extensión profunda con 3 bloques convolucionales para mayor capacidad de representación. \\
\hline
...
\end{itemize} & Idéntica configuración \\
\hline
\end{tabular}
\end{table}
...
\hline
\textbf{Categoría} & \textbf{Métrica} & \textbf{H2\_MOD.A (9 capas)} & \textbf{12 Capas} & \textbf{Interpretación} \\
\hline
\multirow{2}{*}{Precisión} & Val Accuracy (\%) & \textbf{85.29} & 83.45 & Disminución con mayor profundidad \\
 & Test Accuracy (\%) & N/D & \textbf{85.58} & Generaliza moderadamente bien \\
\hline
\multirow{2}{*}{Pérdida} & Val Loss & \textbf{0.3677} & 0.4095 & Mayor error residual en modelo profundo \\
 & Train Loss & 0.2644 & 0.3061 & Dificultad de optimización \\
\hline
\multirow{3}{*}{Generalización} & Brecha (pp) & 2.86 & 4.13 & Aumento de sobreajuste \\
 & Ratio Train/Val Loss & 1.39 & 1.33 & Menor estabilidad \\
 & Consistencia Épocas Finales & Alta & Media & Volatilidad \\
\hline
\multirow{3}{*}{Métricas por Clase} & Macro F1 (\%) & N/D & 83.54 & Rendimiento no equilibrado \\
 & Weighted F1 (\%) & N/D & 85.54 & Dominado por clases mayoritarias \\
 & Desviación Std F1 & N/D & $\sim$8.2 & Variabilidad entre clases \\
\hline
\multirow{2}{*}{Eficiencia} & Duración Entrenamiento & 33m 48s & $\sim$45m & +33\% estimado \\
 & Memoria GPU & $\sim$3.2GB & $\sim$4.1GB & +28\% estimado \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/H3/ima1.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/H3/ima2.jpg}
    \caption{Loss: Train vs Validation}
    \label{fig:acc-exp3}
\end{figure}
...
\begin{enumerate}
    \item H3 se confirma parcialmente: la profundidad no garantizó mejora.
    \item Punto óptimo en 9 capas bajo esta configuración.
    \item Regularización insuficiente para arquitecturas profundas.
    \item El trade-off precisión–eficiencia es cuantificable.
\end{enumerate}
