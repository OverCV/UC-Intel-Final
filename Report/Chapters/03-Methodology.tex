...
% TODO: Especificar técnicas de augmentation aplicadas
...
\begin{itemize}
    \item Rotaciones leves (±5-10 grados)
    \item Recortes aleatorios (random crops)
    \item Volteos horizontales/verticales
    \item Ajustes de brillo y contraste
    \item Ruido gaussiano moderado
\end{itemize}
